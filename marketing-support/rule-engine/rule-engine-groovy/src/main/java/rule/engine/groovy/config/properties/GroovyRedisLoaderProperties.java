package rule.engine.groovy.config.properties;
...
public class GroovyRedisLoaderProperties implements InitializingBean, EnvironmentAware {
    ...
    public static final String PREFIX = "rule.engine.groovy.redis-loader";
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // 强校验
        if (StringUtils.isBlank(namespace)) {
            throw new UnsupportedOperationException("namespace can not be null.");
        }
    }
