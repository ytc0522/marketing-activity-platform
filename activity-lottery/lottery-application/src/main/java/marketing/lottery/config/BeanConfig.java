package marketing.lottery.config;

import marketing.lottery.domain.pool.DynamicChanceLotteryLotteryAwardPool;
import marketing.lottery.domain.pool.FixChanceLotteryLotteryAwardPool;
